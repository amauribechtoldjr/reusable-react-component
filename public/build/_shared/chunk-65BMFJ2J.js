...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/UI/Layout/index.tsx"' + id);
  };
...
function Layout({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full h-screen bg-gray-50 flex items-center justify-center", children }, void 0, false, {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1694696730098.6074";
}
function cn(...inputs) {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1694711646067.7517";
}
var buttonVariants = cva("px-8 h-10 rounded-md select-none", {
  variants: {
    variant: {
...
var Button = (0, import_react.forwardRef)(_c2 = ({
  className,
  variant,
  ...props
}, ref) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("button", { ref, className: cn(buttonVariants({
    variant,
    className
  })), "aria-label": `${import_react.Children.toArray(props.children).join(" ")} button`, ...props }, void 0, false, {
...
//# sourceMappingURL=/build/_shared/chunk-65BMFJ2J.js.map
